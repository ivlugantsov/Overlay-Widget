...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let yandexTokenStore = KeychainService(service: "com.ivlugantsov.OverlayWidget.yandexToken")
    private let finnhubTokenStore = KeychainService(service: "com.ivlugantsov.OverlayWidget.finnhubToken")
